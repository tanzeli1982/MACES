...
try:
    ...
    sed1_1BF = np.array(nc.variables['TSM'][0,day0*24:day1*24+1,index1])
    ...
    sed1_2BF = np.array(nc.variables['TSM'][0,day0*24:day1*24+1,index2])
...
sed1_1BF = 1e3 * np.reshape(sed1_1BF,(24*(day1-day0)+1))    # mg/l
...
sed1_2BF = 1e3 * np.reshape(sed1_2BF,(24*(day1-day0)+1))    # mg/l
...
try:
    ...
    sed2_1BF = np.array(nc.variables['TSM'][0,day0*24:day1*24+1,index1])
    ...
    sed2_2BF = np.array(nc.variables['TSM'][0,day0*24:day1*24+1,index2])
...
sed2_1BF = 1e3 * np.reshape(sed2_1BF,(24*(day1-day0)+1))    # mg/l
...
sed2_2BF = 1e3 * np.reshape(sed2_2BF,(24*(day1-day0)+1))    # mg/l
...
ax.set_title('1BF', fontsize=12, fontname='Times New Roman', color='black')
...
ax.set_ylim(0, 0.5)
ax.xaxis.set_ticks(np.arange(0,nt1_model,24))
ax.yaxis.set_ticks(np.linspace(0,0.5,6))
ax.set_xticklabels(['12/10','12/11','12/12'])
ax.xaxis.set_minor_locator(AutoMinorLocator(4))
...
ax.set_xticklabels(['12/10','12/11','12/12'])
ax.xaxis.set_minor_locator(AutoMinorLocator(4))
ax.set_title('2BF', fontsize=12, fontname='Times New Roman', color='black')
labels = ax.get_xticklabels() + ax.get_yticklabels()
[label.set_fontname('Times New Roman') for label in labels]
[label.set_fontsize(12) for label in labels]
[label.set_color('black') for label in labels]
